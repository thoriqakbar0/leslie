...
- `outputs/adhd-todo-worklog-research.md`
- `outputs/leslie-behavioral-barriers-research.md`
- `outputs/leslie-planned-worklog-structure-research.md`
- `outputs/leslie-retrospective-factual-logging-research.md`
- `outputs/leslie-smallest-acceptable-start-research.md`
- `docs/research/safe-plan-deferral-journal-research.md`

## What you promise — one level up

**P1.** The to-do list you’ll actually keep.

Reworked from: “Make peace with what got done.”

Why it survived: it states the behavior Leslie is designed around—returning after plans change—and
contrasts it with task systems that turn an unfinished list into backlog pressure.
...
- “Make peace with what got done.” — retired from the hero because it is an aspiration without a
  concrete product change. The calmer emotional idea remains in the site's supporting language.
